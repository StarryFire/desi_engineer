// Docs: https://keyes.ie/things/baseliner/, Github: https://github.com/jkeyes/baseline
...
var Baseliner = function (options) {
  ...
  this.create = function () {
    ...
    var svgURL =
      ...
      this.opts.gridSpace +
      "' height='" +
      this.opts.gridHeight +
      "'><rect style='fill: " +
      this.opts.gridColor +
      ";'  width='1' height='0.25px' x='0' y='" +
      (this.opts.gridHeight - 1) +
      "'/></svg>\")";
  ...
  init = function () {
    switch (baseliner.opts.gridColor) {
      case "green":
        baseliner.opts.gridColor = [0, 0xff, 0];
        break;
      case "blue":
        baseliner.opts.gridColor = [0, 0, 0xff];
        break;
      case "red":
        baseliner.opts.gridColor = [0xff, 0, 0];
        break;
      case "black":
        baseliner.opts.gridColor = [0, 0, 0];
        break;
    }
    baseliner.opts.gridColor =
      "rgb(" +
      baseliner.opts.gridColor[0] +
      "," +
      baseliner.opts.gridColor[1] +
      "," +
      baseliner.opts.gridColor[2] +
      ")";
