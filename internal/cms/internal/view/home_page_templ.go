...
import "github.com/starryfire/desi_engineer/config/cmsconfig"
...
func HomeSEOMetaTags(title string, description string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/cms/internal/view/home_page.templ`, Line: 14, Col: 15}
		}
...
func HomePage(props HomePageProps) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = layout.Base(layout.BaseProps{
			...
			ExtraMetaTags: HomeMetaTags(cmsconfig.HOME_PAGE_TITLE, cmsconfig.HOME_PAGE_DESCRIPTION),
