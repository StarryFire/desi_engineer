...
func ServerError(eCtx echo.Context, message string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if projectconfig.ENV == projectconstant.ENV_DEV {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/component/server_error.templ`, Line: 11, Col: 15}
			}
