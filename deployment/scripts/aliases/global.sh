...
DOCKER_COMPOSE_FILES="-f $DOCKER_COMPOSE_BASE_FILE -f $DOCKER_COMPOSE_NETWORKS_FILE -f $DOCKER_COMPOSE_PROXY_FILE -f $DOCKER_COMPOSE_MONITORING_EXPORTERS_FILE -f $DOCKER_COMPOSE_MONITORING_COLLECTORS_FILE"
